...
#$ -o $HOME/hpc-project/openmpihybrid/knapsackResult/
#$ -e $HOME/hpc-project/openmpihybrid/knapsackResult/
...
mpiexec -ppn 1 -f $MPICH_MACHINES -n $NSLOTS $HOME/hpc-project/openmpihybrid/knapsackDYN-hybrid $1
